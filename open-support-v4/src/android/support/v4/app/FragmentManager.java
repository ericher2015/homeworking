...
public abstract class FragmentManager {
    ...
    public abstract void popBackStack(boolean animationEnable);
    public abstract boolean popBackStackImmediate(boolean animationEnable);
    public abstract void popBackStack(String name, int flags,boolean animationEnable);
    public abstract boolean popBackStackImmediate(String name, int flags,boolean animationEnable);
    public abstract void popBackStack(int id, int flags,boolean animationEnable);
    public abstract boolean popBackStackImmediate(int id, int flags,boolean animationEnable);
    /**
...
final class FragmentManagerImpl extends FragmentManager {
    ...
    public boolean popBackStackImmediate(){
    	return popBackStackImmediate(true);
    }
    public void popBackStack(String name, int flags){
    	popBackStack(name, flags, true);
    }
    public boolean popBackStackImmediate(String name, int flags){
    	return popBackStackImmediate(name,flags,true);
    }
    public void popBackStack(int id, int flags){
    	popBackStack(id, flags, true);
    }
    public boolean popBackStackImmediate(int id, int flags){
    	return popBackStackImmediate(id, flags, true);
    }
    
    @Override
    public void popBackStack(boolean animationEnable) {
    ...
    @Override
    public boolean popBackStackImmediate(boolean animationEnable) {
        checkStateLoss();
    ...
    @Override
    public void popBackStack(final String name, final int flags,final boolean animationEnable) {
        enqueueAction(new Runnable() {
            @Override public void run() {
                popBackStackState(mActivity.mHandler, name, -1, flags,animationEnable);
            }
        }, false);
    }

    @Override
    public boolean popBackStackImmediate(String name, int flags,final boolean animationEnable) {
        checkStateLoss();
        executePendingTransactions();
        return popBackStackState(mActivity.mHandler, name, -1, flags,animationEnable);
    }

    @Override
    public void popBackStack(final int id, final int flags,final boolean animationEnable) {
        if (id < 0) {
            throw new IllegalArgumentException("Bad id: " + id);
        }
        enqueueAction(new Runnable() {
            @Override public void run() {
                popBackStackState(mActivity.mHandler, null, id, flags,animationEnable);
            }
        }, false);
    }

    @Override
    public boolean popBackStackImmediate(int id, int flags,final boolean animationEnable) {
        checkStateLoss();
        executePendingTransactions();
        if (id < 0) {
            throw new IllegalArgumentException("Bad id: " + id);
        }
        return popBackStackState(mActivity.mHandler, null, id, flags,animationEnable);
    }
    ...
    boolean popBackStackState(Handler handler, String name, int id, int flags) {
    	return popBackStackState(handler,name,id,flags,true);
    }
    boolean popBackStackState(Handler handler, String name, int id, int flags,boolean animationEnable) {
        if (mBackStack == null) {
            return false;
        }
        if (name == null && id < 0 && (flags&POP_BACK_STACK_INCLUSIVE) == 0) {
            ...
            bss.popFromBackStack(true,animationEnable);
            reportBackStackChanged();
        } else {
            int index = -1;
            if (name != null || id >= 0) {
            ...
            for (int i=0; i<=LAST; i++) {
                ...
                states.get(i).popFromBackStack(i == LAST,animationEnable);
            }
            reportBackStackChanged();
        }
        return true;
